...
import sys
from PyQt5.QtWidgets import QApplication, QWidget, QVBoxLayout, QPushButton, QTabWidget, QLabel, QGraphicsView, QGraphicsScene, QPixmap
import rclpy
...
class MyGuiNode(QWidget):
    ...
    def init_ui(self):
        ...
        image_view = QGraphicsView(image_scene)
    ...
    def image_callback(self, msg):
        ...
        q_image = QPixmap.fromImage(QImage(cv_image.data, width, height, bytes_per_line, QImage.Format_RGB888))
